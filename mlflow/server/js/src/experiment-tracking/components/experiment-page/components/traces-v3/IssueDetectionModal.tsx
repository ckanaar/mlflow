...
export const IssueDetectionModal: React.FC<IssueDetectionModalProps> = ({
  ...
  useEffect(() => {
    if (visible && !prevVisibleRef.current) {
      ...
      const tracesToSelect = initialSelectedTraceIds.length > 0 ? initialSelectedTraceIds : availableTraceIds;
      setSelectedTraceIds(tracesToSelect);
    }
    prevVisibleRef.current = visible;
  }, [visible, initialSelectedTraceIds, availableTraceIds]);
